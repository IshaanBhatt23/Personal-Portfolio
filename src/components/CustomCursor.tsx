...
export const CustomCursor: React.FC<CustomCursorProps> = ({ isMusicMode }) => {
  ...
  const variants = {
    default: {
      ...
      width: 16,
      borderWidth: '2px',
      // Conditionally change color based on the mode
    ...
    hover: {
      ...
      borderWidth: '2px',
      borderColor: isMusicMode ? '#ff8c00' : '#9933ff',
      backgroundColor: isMusicMode ? 'rgba(255, 140, 0, 0.1)' : 'rgba(153, 51, 255, 0.1)',
    },
  };
  ...
  const dotVariants = {
    ...
    hover: {
      ...
      y: mousePosition.y - 4,
      backgroundColor: isMusicMode ? '#ff8c00' : '#9933ff',
      scale: 0.5 // Shrink the dot on hover for a cleaner look
    },
  }
