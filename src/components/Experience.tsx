...
const Experience = () => {
  ...
  const experiences = [
    ...
    },
    {
      ...
      type: "Leadership",
      achievements: [
        "Identified Gujarat's underrepresentation in tech as a market gap and independently sourced 7 engineering colleges (LD, LJ, 5 GECs) through in-person outreach to HODs — converting institutional stakeholders into program partners",
        "Designed and distributed onboarding collateral highlighting MIT-level speakers, sponsors (OpenAI, Google, Lovable) to drive awareness in tier-3 colleges with no prior exposure to such events, resulting in 400+ student registrations",
        "Recognized as Top 3 globally for community impact across 50 ambassadors — selected for both 2nd and 3rd editions based on regional growth and program execution",
      ],
